...
import MaterialPage from "@/app/material/page";
...
export function AdminDashboard() {
  ...
  const {
    data: { data: userData = [], metadata: metaUser } = {},
    error: errorUserData,
  } = useFetch<BaseResponse<UserResponse>>(`${BASE_URL}/users?page=${currentUserPage - 1}&size=${itemsPerPage}&search=${searchTerm}`);
  ...
  const sidebarItems = [
    ...
    { id: "sizes", label: "Kích thước", icon: Ruler },
    { id: "brands", label: "Thương hiệu", icon: Tag },
    { id: "materials", label: "Chất liệu", icon: Layers },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Cấu hình các tùy chọn hệ thống
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
